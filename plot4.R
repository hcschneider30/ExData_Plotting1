...
# Create a vector with the time for the x-axis of the plot
# first paste the strings for date and time into a single string
# and then convert to the POSIXlt class
